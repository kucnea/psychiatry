                ...
                <tbody>
                  <tr>
                    <td>
                      <span 
                        className="add_title"
                        style={{ marginBottom: "5px", fontSize: "2em", color: "#333", fontWeight: "bold", display: "block", paddingBottom: "3px" }}>한혜림</span>
                  ...
                  {/*
                      <tr>
                          <th style="padding-top:1.000em;text-align:left;color:#333;"><i className="fa fa-chevron-circle-right" style="margin-right:0.250em;color:#7d9d4e;"></i>Tel</th>
                      </tr>
                      <tr>
                          <td style="padding-top:5px;color:#666;line-height:1.750em;"></td>
                      </tr>
                      <tr>
                          <th style="padding-top:1.000em;text-align:left;color:#333;"><i className="fa fa-chevron-circle-right" style="margin-right:0.250em;color:#7d9d4e;"></i>Fax</th>
                      </tr>
                      <tr>
                          <td style="padding-top:5px;color:#666;line-height:1.750em;"></td>
                      </tr>
                      <tr>
                          <th style="padding-top:1.000em;text-align:left;color:#333;"><i className="fa fa-chevron-circle-right" style="margin-right:0.250em;color:#7d9d4e;"></i>E-mail</th>
                      </tr>
                      <tr>
                          <td style="padding-top:5px;color:#666;line-height:1.750em;"></td>
                      </tr>*/}
