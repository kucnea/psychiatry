  ...
  <div id="wrapper">
    ...
    <div id="left_container_board">
      ...
      <article id="bo_v" style={{ width: "100%" }}>
        <header>
          <h1 id="bo_v_title">구리언어심리상담센터 OPEN EVENT </h1>
        </header>
        <section id="bo_v_atc">
          <h2 id="bo_v_atc_title">본문</h2>
          {/* 본문 내용 시작 { */}
          <div id="bo_v_con">
          구리언어심리상담센터에서 오픈 이벤트를 진행중입니다. <br/>
          이벤트 기간 중 초기상담을 무료로 진행하고 있습니다. <br/>
          많은 관심 많은 참여 부탁드립니다. ^ㅡ^ <br/>
          </div>
          {/* } 본문 내용 끝 */}
          <div id="bo_v_img">
            <img alt="공지사항2" src={vars.REACT_APP_URL+'/image/noticedetail2.jpg'}/>
          </div>
          {/* 스크랩 추천 비추천 시작 { */}
          {/* } 스크랩 추천 비추천 끝 */}
        </section>
      ...
      <div id="bo_v_top">
        <ul className="bo_v_nb">
          <li>
            <Link to="/board/community/notice/detail1" className="btn_b01">
              이전글
            </Link>
          </li>{" "}
          <li>
