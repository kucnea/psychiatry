  ...
  <div id="wrapper">
    ...
    <div id="left_container_board">
      ...
      <article id="bo_v" style={{ width: "100%" }}>
        <header>
          <h1 id="bo_v_title">사회적 거리두기 4단계 기간 정상 수업 </h1>
        </header>
        <section id="bo_v_atc">
          <h2 id="bo_v_atc_title">본문</h2>
          {/* 본문 내용 시작 { */}
          <div id="bo_v_con">
          사회적 거리두기 4단계 기간 동안 본 센터는 <br/>
          방역수칙을 준수하며 정상 수업 진행됩니다.<br/>
          감사합니다 ^^<br/>
          </div>
          {/* } 본문 내용 끝 */}
          <div id="bo_v_img">
            <img alt="공지사항2" src={vars.REACT_APP_URL+'/image/noticedetail3.png'}/>
          </div>
          {/* 스크랩 추천 비추천 시작 { */}
          {/* } 스크랩 추천 비추천 끝 */}
        </section>
      ...
      <div id="bo_v_top">
        <ul className="bo_v_nb">
          <li>
            <Link to="/board/community/notice/detail2" className="btn_b01">
              이전글
            </Link>
          </li>{" "}
          <li>
